...
insert into Lop values ('L01','cntt1',15)
insert into Lop values ('L02','cntt2',20)
insert into Lop values ('L03','cntt3',30)
insert into Sinhvien values ('001','Nguyen Van B',cast('2002-08-29' as date), 'L01')
insert into Sinhvien values ('002','Nguyen Van C',cast('2002-03-29' as date), 'L02')
insert into Sinhvien values ('003','Nguyen Van D',cast('2002-04-29' as date), 'L03')
insert into MonHoc values ('mh01','LTCB')
insert into MonHoc values ('mh02','TRR')
insert into MonHoc values ('mh03','TCC')
insert into KetQua values ('001','mh01',7.7)
insert into KetQua values ('001','mh02',7.8)
insert into KetQua values ('003','mh01',9.5)
insert into KetQua values ('002','mh02',8.1)
insert into KetQua values ('001','mh03',5.6)
